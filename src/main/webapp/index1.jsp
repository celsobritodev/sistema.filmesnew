<%@ page languague="java" contentType="text/html; charset=UTF-8" pageEnconding="UTF-8"  %>
...
<link href="<%=request.getContextPach()%>/resources/css/bootstrap.min.css" rel="stylesheet">
<link href="<%=request.getContextPach()%>/resources/css/sticky-footer-navbar.css" rel="stylesheet">>
...
<body class="d-flex flex-column h-100">
	...
	<main class="flex-shrink-0">
		<div class="container">
			...
			<p>
				Back to <a href="/docs/5.2/examples/sticky-footer/">the default
